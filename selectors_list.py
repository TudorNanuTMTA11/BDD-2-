...
class Selectors_List:
    ...
    ITEM_1 = (By.XPATH, '(//img[@class= "product-image-photo"])[1]')
    ITEM_2 = (By.XPATH, '(//img[@class= "product-image-photo"])[2]')
    ITEM_3 = (By.XPATH, '(//img[@class= "product-image-photo"])[3]')
    ITEM_4 = (By.XPATH, '(//img[@class= "product-image-photo"])[4]')
    ITEM_5 = (By.XPATH, '(//img[@class= "product-image-photo"])[5]')
    ITEM_6 = (By.XPATH, '(//img[@class= "product-image-photo"])[6]')
    ITEM_7 = (By.XPATH, '(//img[@class= "product-image-photo"])[7]')
    ITEM_8 = (By.XPATH, '(//img[@class= "product-image-photo"])[8]')
    ITEM_9 = (By.XPATH, '(//img[@class= "product-image-photo"])[9]')
