...
class Selectors_List:
    ...
    WAYFARER_MESSENGER_BAG_SEARCH = (By.XPATH, '//span[@class = "qs-option-name selected"]')
    ...
    SIZE = (By.XPATH,'//div[@class= "swatch-option text selected" and @option-id="166" and @option-label="XS" and @aria-label="XS"]')
